...
export default NoticeDetail = ({ notice }) => {
    ...
    return (
        <Card title={title} containerStyle={{borderRadius: 15}} dividerStyle={{borderColor: '#FF5722'}}>
            ...
            <View style={{flexDirection: 'row', justifyContent:'center', alignContent: 'center', marginTop: 7}}>
                ...
                <TouchableOpacity style={{flex:1, borderWidth: 1, borderColor: '#eee', borderRadius: 10, marginHorizontal: 2, padding: 15, justifyContent: 'center', alignContent: 'center'}} onPress={()=>{ Linking.openURL(ROOT_URL+filelink)}} >
