    ...
    return (
        <Card title={title} containerStyle={{borderRadius: 15, backgroundColor: '#eee'}} dividerStyle={{borderColor: '#FF5722'}}>
            ...
            <View style={{flexDirection: 'row', justifyContent:'center', alignContent: 'center', marginTop: 7}}>
                ...
                <TouchableOpacity style={{flex:1, borderWidth: 1, borderColor: '#666', borderRadius: 0, marginHorizontal: 2, padding: 15, justifyContent: 'center', alignContent: 'center'}} onPress={()=>{ Linking.openURL(ROOT_URL+filelink)}} >
